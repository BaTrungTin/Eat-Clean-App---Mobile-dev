...
data class MealDto(
    ...
    // Ingredients và measurements (TheMealDB có 20 ingredients)
    ...
    fun getIngredientsList(): List<Pair<String, String>> {
        ...
        ingredientFields.forEachIndexed { index, ingredient ->
            if (!ingredient.isNullOrBlank()) {
                val measure = measureFields.getOrNull(index) ?: ""
